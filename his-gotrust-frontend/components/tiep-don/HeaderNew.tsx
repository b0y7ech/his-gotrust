...
export default function HeaderNew({ stats, onVerifyCCCD }: HeaderProps) {
    ...
    <div className="bg-[#0f1419] p-6 border-b border-gray-800">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex-1 flex items-center gap-3">
          ...
          <button 
            onClick={onVerifyCCCD}
            className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#0ea5e9] to-[#06b6d4] text-white rounded-lg hover:from-[#0284c7] hover:to-[#0891b2] transition-all shadow-lg shadow-cyan-500/25"
          >
            <IdentificationIcon className="w-5 h-5" />
            <span className="font-medium">Xác thực CCCD</span>
          </button>
        </div>

        {/* Stats */}
        <div className="flex items-center gap-6">
          <div className="text-center px-4 py-2 bg-[#1e2530] rounded-lg">
          ...
          <div className="text-center px-4 py-2 bg-[#0ea5e9]/10 rounded-lg border border-[#0ea5e9]/30">
